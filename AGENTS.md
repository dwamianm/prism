...
- **RFC-0016** — Durable derivation commits (extraction/plan journaling, idempotent index staging and atomic graph commit are implemented as components; normal ingestion integration and durable extraction scheduling remain pending)
