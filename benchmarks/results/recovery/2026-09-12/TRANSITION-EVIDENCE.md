...
process exited zero. The final full source suite with live PostgreSQL passed 3,100 tests with 84 skips
in 535.73 seconds (native exit 0).
...
end-to-end module passed against the installed wheel. The fresh full suite passed
