...
capture, plus a registered matched-reader BM25 control whose rankings are
independently reconstructed. The [MELT bridge](MELT.md) exercises corrections, conflicts,
