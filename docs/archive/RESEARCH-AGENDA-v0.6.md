> Historical proposal, archived on 2026-09-12. Its scores, failure counts and
> predicted improvements are not current validated PRME results. See the
> [current research agenda](../RESEARCH-AGENDA.md) for evidence and acceptance gates.
