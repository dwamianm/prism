...
Fresh built-in extractions record `speech_act_v9`; derivations prepared from
...
Saved v8, v7 and v6 records also prepare v12, v5 records prepare v11, v4 prepare v10, v3
