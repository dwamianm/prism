...
`MemoryWorkspace` keeps named projects in separate local packs and limits how
many engines stay open. The same owner and entity name can appear in multiple
...
This API implements named local physical partitions. It does not yet implement
PostgreSQL project routing, a synchronous workspace client, hosted credential-to-
project grants, cross-project queries, hierarchy, rename/delete/import, or full
RFC-0004 conformance. PostgreSQL configuration is rejected explicitly. Applications
