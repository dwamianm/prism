...
`speech_act_v6`, and plans made from those outputs record `speech_act_v12`, which
...
action verb and preserve an explicit condition. Saved v5 records prepare v11,
