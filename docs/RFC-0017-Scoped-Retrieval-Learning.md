...
in schema version 15 to 19 receipts, and in rank-fused version 21 receipts) and the recorded sort policy: composite score/path/ID, a separately reranked prefix and
