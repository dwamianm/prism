...
validated fact with the same evidence and quantity identity. V11 adds a narrow
user-only recovery for one leading exact measure after a bounded completed-action
verb; normal evidence and quantity checks still apply. V12 can recover an
