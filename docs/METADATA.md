...
materialization plans backed by `speech_act_v4` extraction records use
`speech_act_v10`; saved v3 records remain v9 and v2 records remain v8. The quantity representation is unchanged from
...
`temporal_validity_v7`. Version 10 retains v7 temporal validity and rejects a
