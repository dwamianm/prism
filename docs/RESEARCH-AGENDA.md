...
| Local claim verification | The registered [20-case minimal-evidence assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-MINIMAL-GROUPS-V1.md) and later [48-case broad assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-BROAD-DEV-V1.md) exposed unsafe refutation and support behavior. Causal guards and caller-order preservation passed same-cohort confirmations, reaching 44/48 with zero unsafe supports and 6/6 minimal groups. A new [44-case previously unexecuted guard assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-GUARD-GENERALIZATION-V1.md) retained all ten completed-action refusals, 6/6 explicit refutations, 6/6 new chains, 4/4 conflicts and 4/4 completeness boundaries. | The new assay still failed: three negative distractors about another relation became `refuted`, and a fourth became falsely `contested`. Broad negation cues and noun overlap are insufficient relation corroboration. Two modal supports were also missed. These are authored probes with one pinned model, not independent accuracy evidence. Verification remains opt-in and the untouched failure blocks promotion until a stricter proposition-alignment rule passes a frozen confirmation. |
