...
| Interactive task completion | The [MemoryArena adapter](../benchmarks/results/research/2026-09-12/AGENTIC-MEMORY-INTEGRATION.md) passed the unmodified upstream client with installed PRME, real embeddings, task isolation and restart provenance. The corrected travel trial then completed a fresh 12-group [confirmation](../benchmarks/results/research/2026-09-17/MEMORYARENA-TRAVEL-DEEPSEEK-CONFIRM12-V1.md): PRME used 19.76% fewer input tokens but scored 0.00 strict PS and 65.12 SPS versus native history at 7.69 and 80.24, failing both -5-point non-inferiority gates. Prompt-only V12/V13 repairs failed targeted inspection. V14 typed context improved exact qualified values from V11's 239/318 to 244/318 but missed the strict PS floor by 0.1282 points. [V15 execution-only resolution](../benchmarks/results/research/2026-09-18/MEMORYARENA-TRAVEL-DEEPSEEK-DEV12-V15.md) sent zero qualified arguments to tools and passed both broad gates, but final-answer fidelity fell to 234/318. [V16 call-local presentation metadata](../benchmarks/results/research/2026-09-18/MEMORYARENA-TRAVEL-DEEPSEEK-DEV12-V16.md) matched all 626 executions, recorded 462 exact binding uses, attached 444 model-visible annotations, sent zero qualified arguments to tools, preserved 252/318 exact qualified outputs, passed both broad gates at -1.28 PS and +1.35 SPS, and used 17.85% fewer input tokens. | V16 is the first candidate to pass both broad and targeted development selection rules. Run one fresh confirmation excluding every group in prior travel registrations. Require complete execution, zero qualified arguments at the underlying tools and both broad non-inferiority gates; report the new cohort's full qualified-value denominator and a causal no-annotation comparison before claiming the output gain reproduced. The mutable hosted alias, one generation per arm and exact-string scorer prevent broader claims. |
