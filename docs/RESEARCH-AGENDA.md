...
| External lifecycle and scale workflows | The registered MELT run completed five seeds and all 20 lifecycle checkpoints at recall@12 and NDCG@12 of 1.000. The corrected [BEAM extracted-memory run](../benchmarks/results/research/2026-09-15/BEAM-100K-EXTRACTED-SCORED.md) scored 13/20 with a 0.56750 mean rubric score after schema-5 validation confirmed 188/188 raw materializations and extractions. Its top-50 results contained a median 48 unique passage texts. | MELT uses four held-out lifecycle cases and a deterministic embedding profile. BEAM covers one tuned 100K conversation with mutable hosted model aliases; abstention and event ordering each scored 0/2, and no cross-product leadership is established. |
