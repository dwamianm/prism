...
|---|---|---|
| Product context packing | The default balanced policy improved a fixed 35B reader from 67/119 to 83/119 on the development cohort and from 185/381 to 250/381 on a separately registered answer confirmation. It improved every category or tied. A later [500-question episode-composition grid](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-EPISODE-COMPOSITION-V1.md) rejected all five candidates because promoted episodes displaced evidence. The [session-marginal grid](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-SESSION-MARGINAL-V1.md) found one lossless mild arm, but its [answer diagnostic](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-SESSION-MARGINAL-ANSWER-V1.md) tied 25/31. Named grouping then preserved exact control evidence and saved 273.774 mean tokens in a [500-question source trial](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-GROUPED-CONVERSATIONS-V1.md), but its [registered answer trial](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-GROUPED-CONVERSATIONS-ANSWER-DEV-V1.md) fell from 71/119 control to 68/119 with the same evidence and 64/119 after fill. Order-preserving [metadata factoring](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-FACTORED-ANSWER-DEV-V1.md) then saved 725.471 mean tokens while retaining every exact field and record, but fell from 73/119 to 69/119. | Both source partitions and the full LongMemEval-S composition cohort had already been inspected. One local reader and one custom calibrated local judge support balanced; later composition work is development-only. Group coalescing changed relevance order, while exact reversible field inheritance still increased unsupported caution on cross-record aggregation and updates. Reject both compact renderers and stop tuning generic serialization on this inspected split. Preserve explicit per-record metadata and keep episode routing opt-in. |
...
| Exact quantity extraction and aggregation | The registered [DeepSeek development pass](../benchmarks/results/research/2026-09-18/QUANTITY-EXTRACTION-DEEPSEEK-DEV-V5.md) and [local Qwen 35B-A3B confirmation](../benchmarks/results/research/2026-09-18/QUANTITY-EXTRACTION-QWEN-CONFIRM-V3.md) passed 40/40 combined v10 cases and 24/24 expected quantity instances with zero extras or provider failures. The first [durable end-to-end aggregation assay](../benchmarks/results/research/2026-09-18/QUANTITY-AGGREGATION-E2E-QWEN-V1.md) exposed a dropped `5 kilometers` action and an exact-selector miss. The preregistered [v2 confirmation](../benchmarks/results/research/2026-09-18/QUANTITY-AGGREGATION-E2E-QWEN-V2.md) closed both gaps: fresh v11 extraction passed 10/10 source contracts, explicit token-prefix composition selected 4/4 charity contributions, and the public API returned exact `$3,750` with all unrelated, negated, conditional, approximate, incompatible-unit and cross-owner controls excluded. | Authored cases through one local Qwen artifact and one Ollama-compatible interface, not held-out extraction accuracy, exhaustive verb/unit coverage, natural-language query planning, or competitive evidence. Source-derived repair uses bounded lexicons and never converts units. Prefixes are caller-selected lexical composition; an overbroad prefix can admit an unintended predicate. Exact aggregation still reports unknown extraction and real-world coverage. |
...
| Local claim verification | Early registered assays exposed unsafe model-only refutation, speech-act collapse, missed conflicts and evidence-order sensitivity; each failed result is retained. Pinned MiniCheck trials culminated in a preregistered [atomic follow-up](../benchmarks/results/research/2026-09-16/WICE-MINICHECK-FLAN-ATOMIC-V1.md): human decomposition reconstructed 357/358 parents, while the model reached 76.04% precision and 66.36% recall. A fresh [SummEdits proof trial](../benchmarks/results/research/2026-09-16/SUMMEDITS-PROOF-VERIFICATION-V1.md) rejected free-form quotations. The causal [segment-ID v2](../benchmarks/results/research/2026-09-16/SUMMEDITS-SEGMENT-VERIFICATION-V2.md) reached 99.00% reference integrity, 72.00% recall and 76.00% balanced accuracy, but only 78.26% precision. An [independent critic](../benchmarks/results/research/2026-09-16/SUMMEDITS-INDEPENDENT-CRITIC-V3.md) reduced false support to 8.00% while collapsing recall to 30.00%. A balanced 1,100-claim [LLM-AggreFact FactCG trial](../benchmarks/results/research/2026-09-16/LLM-AGGREFACT-FACTCG-V1.md) reached only 79.44% precision at 61.82% recall. Its preregistered [evidence-local Mistral cascade](../benchmarks/results/research/2026-09-16/LLM-AGGREFACT-EVIDENCE-CASCADE-V2.md) improved recall but reached only 85.12% precision at 63.45% recall; at 90% precision recall fell to 36.55%. A pinned 8B [Bespoke sentence-fusion trial](../benchmarks/results/research/2026-09-16/LLM-AGGREFACT-BESPOKE-SENTENCE-FUSION-V3C.md) reached 83.54% precision at 60.91% recall; at 90% precision recall fell to 38.00%. It also exposed two MPS generation failures before a direct no-cache forward completed development. A document-grouped [structured FactCG stack](../benchmarks/results/research/2026-09-16/LLM-AGGREFACT-STRUCTURED-STACK-V1B.md) added lexical alignment, numeric/name anchors and negation agreement, but no inner cross-fit found the required threshold; post hoc outer scores reached only 81.13% precision at 60.18% recall. The preregistered [source-bound typed-reference trial](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-TYPED-REFERENCE-V2.md) eliminated generated quotations and improved observed reference integrity over the copied-text prototype, but stopped at 285/310 valid cases after 17 cloud timeouts and eight typed-reference failures made its 98% gate impossible. No classifier metrics were computed and the external test cohort remained sealed. A post hoc [native-tool recovery diagnostic](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-TYPED-TOOL-RECOVERY.md) then completed 93/93 DeepSeek cloud transport calls in 26–32 seconds per 25-case run, versus the earlier 106-minute provider wall time. Semantic validity reached 20/25 and 17/25; identical first requests produced identical tool arguments in only 3/25 cases. The pinned local Qwen 35B control exhausted all three semantic attempts on its first ten fully observed cases. The follow-up [source-token partition diagnostic](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-ATOMIC-PARTITION-V2.md) achieved 310/310 valid DeepSeek partitions and 307/310 valid Qwen partitions with three safe abstentions, but the paired unsplit FactCG control outperformed both atomic paths: 75.90% balanced accuracy and 16.88% false support versus 74.67%/30.00% and 75.52%/35.62%. Neither reached 90% precision at 60% recall. The whole-claim [evidence-lattice follow-up](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-EVIDENCE-LATTICE-V1.md) found only a 0.35-point post hoc balanced-accuracy gain from reversing evidence order; subset maximization regressed and every static policy failed the same joint target. A fresh 780-claim [HHEM-2.1-Open windowed trial](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-HHEM-WINDOWED-V2.md) covered all selected evidence within the model's 512-token limit but reached only 72.82% best balanced accuracy and 77.67% precision above 60% recall, below the exact-cohort FactCG control. A separate 800-claim [full-source support-certificate trial](../benchmarks/results/research/2026-09-17/LLM-AGGREFACT-SUPPORT-CERTIFICATE-V1.md) removed the ranker and required complete source-bound atom verdicts. DeepSeek produced 782 valid certificates and reached 78.31% precision at 65.00% recall, but its 18.00% false-support rate and strong domain instability failed the fixed gates. | WiCE assumes perfect retrieval and SummEdits uses controlled edits over 40 repeated source families. Keep verification opt-in. General-model unanimity, direct task-model classification, shallow structural stacking, evidence-local ranker/verifier intersection, in-process typed provider verification and redundant generated range schemas are rejected. Durable native tools now solve restart and transport behavior. Structural token coverage and explicit fail-closed abstention are now demonstrated, but provider-authored claim fragmentation is rejected because it did not improve the paired task-model control and the two providers agreed on only 7/310 exact partitions. Preserve whole-claim semantics. The bounded evidence lattice is also closed without learned fitting. The licensed, immutable HHEM specialized-model trial failed on a registered disjoint cohort, so static maximum-over-window verification is closed for that model too. A full-source provider certificate then supplied explicit partial-support and abstention semantics without the ranker, but still failed structural and semantic gates. Static verifier development is closed for this milestone; return to higher-impact memory gaps. Do not add provider verification until a materially different method passes fresh development and untouched external cohorts. |
...
| MemoryAgentBench test-time learning | [Matched Banking77 development comparison](../benchmarks/results/research/2026-09-14/MEMORYAGENTBENCH-BANKING-STRICT-DEV20.md): PRME scored 20/20 versus BM25 at 17/20 under the official strict metric, while using 90.52% fewer retrieved-context tokens. The [episode regression](../benchmarks/results/research/2026-09-14/MEMORYAGENTBENCH-EPISODE-REGRESSIONS-DEV20.md) preserved PRME at 20/20 with all 220 routed promotions packed. Public atomic batch admission subsequently reduced the same 5,897-record construction from 463.112 to 47.401 seconds (9.77x), and owner-scoped request IDs now make lost-response retries safe across restart. | Twenty previously inspected development questions, one reader and one lexical control. The paired interval includes zero. The bulk timing is one local-host observation over raw NOTE materialization and does not establish extracted-memory throughput. |
...
| Interactive task completion | The [MemoryArena adapter](../benchmarks/results/research/2026-09-12/AGENTIC-MEMORY-INTEGRATION.md) passed the unmodified upstream client with installed PRME, real embeddings, task isolation and restart provenance. The corrected travel trial then completed a fresh 12-group [confirmation](../benchmarks/results/research/2026-09-17/MEMORYARENA-TRAVEL-DEEPSEEK-CONFIRM12-V1.md): PRME used 19.76% fewer input tokens but scored 0.00 strict PS and 65.12 SPS versus native history at 7.69 and 80.24, failing both -5-point non-inferiority gates. Prompt-only V12/V13 repairs failed targeted inspection. V14 typed context improved exact qualified values from V11's 239/318 to 244/318 but missed the strict PS floor by 0.1282 points. [V15 execution-only resolution](../benchmarks/results/research/2026-09-18/MEMORYARENA-TRAVEL-DEEPSEEK-DEV12-V15.md) sent zero qualified arguments to tools and passed both broad gates, but final-answer fidelity fell to 234/318. [V16 call-local presentation metadata](../benchmarks/results/research/2026-09-18/MEMORYARENA-TRAVEL-DEEPSEEK-DEV12-V16.md) passed its development rules, but the fresh [three-arm confirmation](../benchmarks/results/research/2026-09-18/MEMORYARENA-TRAVEL-DEEPSEEK-CONFIRM12-V2.md) rejected it: exact qualified outputs were 352/457 versus 361/457 for the matched no-guidance control, strict SPS trailed native by 7.63 points, and incomplete compound-field binding coverage let ten qualified control arguments reach tools. A subsequent [model-free corpus audit](../benchmarks/results/research/2026-09-18/MEMORYARENA-VALUE-BINDING-COVERAGE-V1.md) covered all 10,518 qualified occurrences across 2,139 reference plans with zero missing or unexpected bindings; the adapter now blocks any unresolved qualified value before tool execution. The [structured restoration audit](../benchmarks/results/research/2026-09-18/MEMORYARENA-STRUCTURED-PRESENTATION-V1.md) then restored all 10,518 declared atomic targets with exact tool-call provenance while leaving untargeted values, free text and caller inputs unchanged. | Do not enable the result-guidance candidate or repeat its free-form instruction. Retain exact typed resolution and structured restoration as opt-in capabilities. Next integrate restoration at the parsed MemoryArena plan boundary and preregister a fresh matched development comparison against exact resolution without restoration. The mutable hosted alias, one generation per arm and exact-string scorer prevent broader claims. |
...
but its interval includes zero. A later public atomic-batch trial reduced the same
5,897-record construction from 463.112 to 47.401 seconds, and durable request
identities now make exact retries safe across restart. The subsequent matched
