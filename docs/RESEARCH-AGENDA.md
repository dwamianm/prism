...
|---|---|---|
| Product context packing | The default balanced policy improved a fixed 35B reader from 67/119 to 83/119 on the development cohort and from 185/381 to 250/381 on a separately registered answer confirmation. It improved every category or tied. A later [500-question episode-composition grid](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-EPISODE-COMPOSITION-V1.md) rejected all five candidates because promoted episodes displaced evidence. The [session-marginal grid](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-SESSION-MARGINAL-V1.md) found one lossless mild arm, but its [answer diagnostic](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-SESSION-MARGINAL-ANSWER-V1.md) tied 25/31. Named grouping then preserved exact control evidence and saved 273.774 mean tokens in a [500-question source trial](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-GROUPED-CONVERSATIONS-V1.md), but its [registered answer trial](../benchmarks/results/research/2026-09-18/LONGMEMEVAL-S-GROUPED-CONVERSATIONS-ANSWER-DEV-V1.md) fell from 71/119 control to 68/119 with the same evidence and 64/119 after fill. | Both source partitions and the full LongMemEval-S composition cohort had already been inspected. One local reader and one custom calibrated local judge support balanced; later composition work is development-only. Group coalescing changed relevance order and the visible session structure increased unsupported caution on aggregation and updates. Reject the tested grouped renderer and fill policy. Any follow-up must first preserve record order and pass same-evidence answer noninferiority. Keep episode routing opt-in. |
