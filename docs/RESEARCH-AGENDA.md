...
| Local claim verification | The registered [20-case minimal-evidence assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-MINIMAL-GROUPS-V1.md) found both unseen two-passage chains, every explicit refutation and conflict, and both completeness boundaries, but overcalled two neutral passages as refutations. The deterministic guard developed from that failure passed a [same-cohort confirmation](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-GUARDED-REFUTATION-V2.md). A later [48-case previously unexecuted assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-BROAD-DEV-V1.md) matched 40/48 but failed with two unsafe supports. Speech-act support gating and a separately identified near-exact negation basis then passed all eight gates in a [same-cohort safety confirmation](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-BROAD-SAFETY-V2.md): identical raw scores, exactly two corrected statuses, zero unsafe supports, 12/12 insufficient cases and 4/4 conflicts. | Both passing confirmations reused observed failure cohorts. All four implicit contradictions remain unresolved by policy, and two of six new relation-composition pairs remain insufficient. These are authored probes with one pinned model, not independent accuracy evidence. Keep verification opt-in until an untouched cohort tests false-positive risk, typed modality, implicit contradiction and multi-passage composition together. |
