...
| Local claim verification | The registered [20-case minimal-evidence assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-MINIMAL-GROUPS-V1.md) found both unseen two-passage chains, every explicit refutation and conflict, and both completeness boundaries, but overcalled two neutral passages as refutations. The deterministic guard developed from that failure passed all eight gates in a [same-cohort confirmation](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-GUARDED-REFUTATION-V2.md). A later [48-case previously unexecuted assay](../benchmarks/results/research/2026-09-16/CLAIM-VERIFICATION-BROAD-DEV-V1.md) matched 40/48 and retained 6/6 explicit refutations, 11/12 insufficient cases, 4/6 new minimal groups and 4/4 completeness refusals. | The broader assay failed its zero-unsafe-support gate twice: desire became completion, and missed counterevidence turned a conflict into support. All four implicit contradictions remained `insufficient`, exposing the guarded policy's recall cost. These are authored probes with one pinned model, not independent accuracy evidence. Support needs a speech-act guard and explicit conflicts need a narrow auditable fallback before another frozen trial. |
