...
| Profile maintenance recovery | Durable prepared inputs, owner-scoped Python recovery, journal reconstruction and fenced replacement are implemented. Next: explicit abandonment and safe collection of unpublished staging, then scheduled maintenance policy. No automatic profile scheduler is present. |
